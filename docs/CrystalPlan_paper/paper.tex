...
calculations \cite{numpy}. Some of the critical calculations were also written
with inline C code, which speed up some calculations by up to $400\times$ as compared with
...
%, whereas the RMS of the detector position error was 7.6 mm.
...
single $hkl$.}
\ifdograph
  \includegraphics[width=2.5in]{single_reflection_3}
\fi
